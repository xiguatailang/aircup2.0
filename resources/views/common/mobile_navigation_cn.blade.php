...
<div class="menu">
    <ul>
        ...
        <li><a href="{{ url('/creation') }}">造物记</a></li>
        <li><a href="{{ url('/about') }}">关于我们</a></li>
        <li><a href="https://www.kickstarter.com/projects/aircup/light-video-a-pair-of-magic-ar-smart-glasses?ref=guanwang_cn" target="_blank">预订购买</a></li>
